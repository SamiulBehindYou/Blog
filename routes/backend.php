...
Route::middleware('auth')->group(function () {
    ...
    //Tags
    Route::get('tag/addtag', [TagController::class, 'add_tag'])->name('add.tag');
    ...
    Route::get('all/blog/hard/{id}', [AdminBlogController::class, 'blog_delete'])->name('blog.delete');

    Route::get('admin/blog/update/{id}', [AdminBlogController::class, 'blog_edit'])->name('admin.blog.edit');
    Route::post('/admin/blog/update', [AdminBlogController::class, 'blog_update'])->name('admin.blog.update');
